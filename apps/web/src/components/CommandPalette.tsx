...
export function CommandPalette() {
  ...
  const commands = useMemo<Command[]>(() => {
    ...
    const list: Command[] = [
      ...
      { id: 'theme:light', group: 'theme', title: t('palette.lightTheme'), icon: Sun, run: () => setThemePreference('light') },
      { id: 'theme:dark', group: 'theme', title: t('palette.darkTheme'), icon: Moon, run: () => setThemePreference('dark') },
      { id: 'theme:system', group: 'theme', title: t('palette.systemTheme'), icon: Monitor, run: () => setThemePreference('system') },
